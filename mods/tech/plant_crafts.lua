...
---- Maraka
minetest.register_node('tech:maraka_flour_bitter', { --bitter maraka flour
...
minetest.register_node('tech:maraka_flour', { -- maraka flour--usable flour.
...
minetest.register_node("tech:maraka_bread", { --maraka cake, prior to baking
...
minetest.register_node("tech:maraka_bread_cooked", { --maraka cake,baked
...
minetest.register_node("tech:maraka_bread_burned", { --maraka cake, burned
...
minetest.register_node("tech:mashed_anperla", { --mash (a way to bulk cook tubers - 6 at once)
...
minetest.register_node("tech:mashed_anperla_cooked", {
	...
	sounds      = nodes_nature.node_sound_dirt_defaults(),
	on_use      = function(itemstack, user, pointed_thing)
		if random() < 0.002 then --food poisoning
			HEALTH.add_new_effect(user, {"Food Poisoning", 1})
			end
		return exile_eatdrink(itemstack, user)
		end,
...
minetest.register_node("tech:mashed_anperla_burned", {
	...
	sounds      = nodes_nature.node_sound_dirt_defaults(),
	on_use      = function(itemstack, user, pointed_thing)
		if random() < 0.001 then --food poisoning, lower chance on burned food
			HEALTH.add_new_effect(user, {"Food Poisoning", 1})
			end
		return exile_eatdrink(itemstack, user)
		end,
...
---- Vegetable Oils
minetest.register_craftitem("tech:vegetable_oil", { --vegetable oil
...
---- Recipes
-- Hand Crafts --
crafting.register_recipe({ --Sticks from woody plants
	type   = "crafting_spot",
	output = "tech:stick 2",
...
crafting.register_recipe({ --peel tubers
	type   = "crafting_spot",
...
crafting.register_recipe({ --bulk mash
	type   = "mortar_and_pestle",
...
crafting.register_recipe({ --grind maraka flour
	type   = "mortar_and_pestle",
...
crafting.register_recipe({ --bulk maraka flour
	type   = "mortar_and_pestle",
...
crafting.register_recipe({ --make maraka cakes
	type   = "mortar_and_pestle",
...
crafting.register_recipe({ --bulk maraka cakes
	type   = "mortar_and_pestle",
...
crafting.register_recipe({ --squeeze oil
	type   = "mortar_and_pestle",
...
crafting.register_recipe({ --bulk oil
	type   = "mortar_and_pestle",
...
crafting.register_recipe({ --sticks from tree
	type   = "chopping_block",
...
crafting.register_recipe({ --sticks from log slabs
	type   = "chopping_block",
