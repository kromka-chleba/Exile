...
function tech.get_container_tiles(mat, container, suffix)
    if not mats_def[mat] then
        core.log ("to tech.get_container_tiles: "
...
for _, container in pairs ({"water_pot", "watering_can"}) do
    for mat, _ in pairs (mats_def) do
        ...
        local def = {
            ...
            -- dapperance
            tiles = tech.get_container_tiles(mat, container),
            drawtype = "nodebox",
            ...
            groups = {
                ...
                -- TODO I could name it "container ?" the  group:container/pot ?
                -- would be good to automatically add it to containers
            }
        }
        ...
        if container == "water_pot" then
            ...
            --register container and add pot group
            def.groups.pot = 1
...
local function get_base_def(mat, container, liquid)
    local def = {
        ...
        tiles = tech.get_container_tiles(mat, container, "^tech_pot_water.png"),
        node_box = nodeboxes[container]
    }
...
for _, glass in pairs ({"green", "clear"}) do
    ...
    minetest.register_node("tech:glass_bottle_" .. glass, def)
    -- Crafting
    -- Blown from glass
