...
liquid_store.register_stored_liquid(
    "tech:clay_water_salt_water",{
        ...
        on_timer = function(pos, elapsed)
            ...
            return ncrafting.roast(pos, name, name:sub(1,#name-10).."pot_dry_salt", nil, 102)
        end
})
...
liquid_store.register_stored_liquid(
    "tech:glass_bottle_green_saltwater",{
        ...
        groups = {dig_immediate = 2},
        tiles  = {"tech_bottle_green.png^(tech_bottle_liquid_blank.png"..
...
liquid_store.register_stored_liquid(
    "tech:glass_bottle_clear_saltwater",{
        ...
        groups = {dig_immediate = 2},
        tiles = {
            "tech_bottle_clear.png^(tech_bottle_liquid_blank.png"..
                "^[colorize:#17453c^tech_bottle_liquid_pattern.png^[opacity:220)"
        },
        use_texture_alpha = c_alpha.blend,
        sunlight_propagates = true,
        stack_max = minimal.stack_max_bulky * 2,
...
liquid_store.register_stored_liquid(
    "tech:glass_bottle_green_freshwater",{
        ...
        empty = "tech:glass_bottle_green",
        tiles = {
            "tech_bottle_green.png^(tech_bottle_liquid_blank.png"..
                "^[colorize:#244862^tech_bottle_liquid_pattern.png^[opacity:220)"},
