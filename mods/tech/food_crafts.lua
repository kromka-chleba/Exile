...
minetest.register_node(
    "tech:maraka_dough_fermented",  {
        ...
        groups = {dig_immediate = 3, falling_node=1, fermented_dough=1, fermented_bread_dough=1},
        sounds = nodes_nature.node_sound_dirt_defaults(),
        paramtype = "light",
...
minetest.register_node(
    "tech:rhuya_dough_fermented",  {
        ...
        groups = {dig_immediate = 3, falling_node=1, fermented_dough=1, fermented_cake_dough=1},
        sounds = nodes_nature.node_sound_dirt_defaults(),
        paramtype = "light",
        preserve_metadata = ferm_dough_preserve_metadata
})
