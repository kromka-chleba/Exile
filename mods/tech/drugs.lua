...
liquid_store.register_stored_liquid(
    "tech:tang_vinegar",{
        ...
        sl_groups = {"vinegar", "tang_vinegar"}, -- to be added to liquid_stored table
...
minetest.register_node(
    "tech:wooden_tang_vinegar_mother",{
        description = S("Tang Vinegar with Mother"),
        stack_max = 1,
        tiles = {
            "tech_primitive_wood.png^tech_pot_empty.png"..
        ...
        drop = {
            items = {
                {rarity=1,items={"tech:wooden_tang_vinegar",
                                 "tech:mother_of_tang"}},
                {rarity=4,items={"tech:mother_of_tang"}}
            },
        },
...
liquid_store.register_stored_liquid(
    "tech:tang",{
        ...
        _preserve_metadata = function(pos, oldnode, oldmeta, transferred_stack)
            ...
            ncrafting.ferment_preserve_metadata(pos, oldnode, oldmeta,
                                                transferred_stack)
        end,
        ...
        _on_use_item = function(player, itemstack, pointed_thing)
            return drink_tang(nil, {name="tech:tang"}, player, itemstack,
                              pointed_thing, true)
        end,
})
liquid_store.register_stored_liquid(
    "tech:wooden_tang",{
        ...
        _use_tip = S("Drink"),
        _on_use_item = function(player, itemstack, pointed_thing)
            return drink_tang(nil, {name="tech:wooden_tang"}, player,
