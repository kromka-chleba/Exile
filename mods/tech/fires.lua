    ...
    "tech:wood_ash_block", {
        ...
        on_use = function(itemstack, user, pointed_thing)
            if pointed_thing.type == "node" then
                return ncrafting.fertilize(pointed_thing.under, user,
                                           itemstack)
            end
        end,
...
minetest.register_node(
    'tech:small_wood_fire', {
        ...
        --walkable = false,
        drop = "tech:wood_ash",
        groups = {crumbly = 1, igniter = 1, falling_node = 1,
        ...
        on_timer =function(pos, elapsed)
            ...
            elseif can_burn_air(pos, meta, "tech:small_wood_fire_smoldering",
                ...
                --add hot air
                climate.air_temp_source(pos, wood_temp_effect, wood_temp_max,
                                        wood_air_c, base_burn_rate)
                -- Restart timer
                return true
            end
        end,
        ...
        on_timer =function(pos, elapsed)
            ...
            elseif can_burn_air(pos, meta, "tech:large_wood_fire_smoldering",
                ...
                climate.air_temp_source(
                    pos, wood_temp_effect*2, wood_temp_max*2,
                    wood_air_c-0.1, base_burn_rate)
                -- Restart timer
                return true
            end
        end,
...
--
minetest.register_node(
    'tech:small_wood_fire_smoldering', {
        ...
        on_timer =function(pos, elapsed)
            ...
            if fuel < 1 then
                ...
                if can_smolder(pos, meta, 'tech:small_wood_fire',
                               "tech:wood_ash") then
                    meta:set_int("fuel", fuel - 1)
                    --add hot air
                    climate.air_temp_source(
                        pos, wood_temp_effect/3, wood_temp_max,
                        wood_air_c+0.3, base_burn_rate)
                    -- Restart timer
                    return true
                end
            end
...
minetest.register_node(
    'tech:large_wood_fire_smoldering', {
        ...
        on_timer =function(pos, elapsed)
            ...
            if fuel < 1 then
                ...
                if can_smolder(pos, meta, 'tech:large_wood_fire',
                               "tech:wood_ash_block") then
                    meta:set_int("fuel", fuel - 1)
                    --add hot air
                    climate.air_temp_source(
                        pos, (wood_temp_effect*2)/3, wood_temp_max*2,
                        wood_air_c+0.15, base_burn_rate)
                    -- Restart timer
                    return true
                end
            end
    ...
    'tech:small_charcoal_fire', {
        ...
        on_timer =function(pos, elapsed)
            ...
            elseif can_burn_air(pos, meta,
                ...
                --add hot air
                climate.air_temp_source(
                    pos, char_temp_effect, char_temp_max,
                    char_air_c, base_burn_rate)
                -- Restart timer
                return true
            end
        end,
    ...
    'tech:large_charcoal_fire', {
        ...
        on_timer =function(pos, elapsed)
            ...
            elseif can_burn_air(
                ...
                --add hot air
                climate.air_temp_source(
                    pos, char_temp_effect*2, char_temp_max*2,
                    char_air_c -0.1, base_burn_rate)
                -- Restart timer
                return true
            end
        end,
        ...
        on_timer =function(pos, elapsed)
            ...
            if fuel < 1 then
                ...
                if can_smolder(pos, meta, 'tech:small_charcoal_fire',
                    ...
                    --add hot air
                    climate.air_temp_source(
                        pos, char_temp_effect/3, char_temp_max,
                        char_air_c +0.3, base_burn_rate)
                    -- Restart timer
                    return true
                end
            end
...
minetest.register_node(
    'tech:large_charcoal_fire_smoldering', {
        ...
        on_timer =function(pos, elapsed)
            ...
            if fuel < 1 then
                ...
                if can_smolder(pos, meta, 'tech:large_charcoal_fire',
                    ...
                    --add hot air
                    climate.air_temp_source(
                        pos, (char_temp_effect*2)/3, char_temp_max*2,
                        char_air_c+0.15, base_burn_rate)
                    -- Restart timer
                    return true
                end
            end
...
crafting.register_recipe({
        ...
        items = {{"group:woody_plant 3","tech:stick 6"},
            "group:fibrous_plant 1"},
        level = 1,
        always_known = true,
})
...
crafting.register_recipe({ -- skip stick craft step
        ...
        items = {{"group:woody_plant 6","tech:stick 12"},
            "group:fibrous_plant 2"},
        level = 1,
        always_known = true,
})
...
crafting.register_recipe({
        ...
        items = {{"group:woody_plant 6","tech:stick 12","group:woodslab"},
            "group:fibrous_plant 2"},
        level = 1,
        always_known = true,
})
...
crafting.register_recipe({
        ...
        items = {{"group:woody_plant 12","tech:stick 24","group:woodslab 2"},
...
crafting.register_recipe({
        type = {"axe"},
        output = "tech:large_wood_fire_unlit 2",
        items = {{"group:woody_plant 12","tech:stick 24","group:log"},
            "group:fibrous_plant 4"},
        level = 2,
        always_known = true,
})
