...
function tgcr.register_replacement(source_node_name, target_node_name, replacement_kind, activation_source_name)
	activation_source_name = activation_source_name or target_node_name -- provide default
	...
	local activation_slopes = naturalslopeslib.get_all_shapes(activation_source_name)
...
function tgcr.find_replacement(source_node_name, replacement_kind, activation_source_name)
...
function tgcr.make_replacement(pos, replacement_kind, activation_source_name)
	...
	local target = {
		name = tgcr.find_replacement(source.name, replacement_kind, activation_source_name),
