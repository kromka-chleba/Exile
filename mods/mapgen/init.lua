...
deco.map_version = dofile(path.."/map_version.lua")

core.set_mapgen_setting(
    "mg_flags",
    "caves, nodungeons, light, decorations, biomes",
    true)
core.set_mapgen_setting(
    "mgvalleys_spflags",
...
core.register_alias("mapgen_stone", "nodes_nature:conglomerate")
core.register_alias("mapgen_water_source", "nodes_nature:salt_water_source")
core.register_alias("mapgen_river_water_source",
                    "nodes_nature:freshwater_source")

function deco.find_schematic(object)
    return path.."/schematics/"..object..".mts"
end
