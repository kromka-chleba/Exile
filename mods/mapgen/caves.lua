...
local cave_life = {
    ...
    {--[[Underground:Cave worms on cave roof]]
        ...
        sidelen = 16,
        noise_params = {offset=-0.04, scale=0.4000, spread={x=64, y=64, z=64},
                        seed=11002, octaves=2, persist=0.9},
        y_max = -15,
        y_min = -1000,
...
local cave_sediments = {
    {--[[Sediments:cavegravel]]
        ...
        place_offset_y = -1,
        sidelen = 04,
        noise_params = {offset=-0.50, scale=3.0000, spread={x=32, y=32, z=32},
                        seed=873515, octaves=2, persist=0.9},
        y_max = 31000,
        y_min = -31000,
    ...
    {--[[Sediments:cavesand]]
        ...
        sidelen = 04,
        noise_params = {offset=-0.50, scale=3.0000, spread={x=32, y=32, z=32},
                        seed=795515, octaves=2, persist=0.9},
        y_max = 31000,
        y_min = -31000,
    ...
    {--[[Sediments:caveclay]]
        ...
        sidelen = 04,
        noise_params = {offset=-0.50, scale=3.0000, spread={x=32, y=32, z=32},
                        seed=87005, octaves=2, persist=0.9},
        y_max = 31000,
        y_min = -31000,
    ...
    {--[[Sediments:cavegravelwet]]
        ...
        place_offset_y = -1,
        sidelen = 04,
        noise_params = {offset=-0.70, scale=3.0000, spread={x=32, y=32, z=32},
                        seed=174415, octaves=2, persist=0.9},
        y_max = 31000,
        y_min = -31000,
    ...
    {--[[Sediments:cavesandwet]]
        ...
        sidelen = 04,
        noise_params = {offset=-0.70, scale=3.0000, spread={x=32, y=32, z=32},
                        seed=796565, octaves=2, persist=0.9},
        y_max = 31000,
        y_min = -31000,
    ...
    {--[[Sediments:cavesiltwet]]
        ...
        sidelen = 04,
        noise_params = {offset=-0.70, scale=3.0000, spread={x=32, y=32, z=32},
                        seed=85025, octaves=2, persist=0.9},
        y_max = 31000,
        y_min = -31000,
