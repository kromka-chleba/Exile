...
---- Wetlands
  ...
  { --[[ Grassland: wrotycz                      ]]    "nodes_nature:wrotycz_seed"       , "simple"   , grassland_on                       , nil,           16,     nil     ,  {offset =  0.00, scale = 0.0020, spread = {x =  32, y =  32, z =  32}, seed =   1003, octaves = 2, persist = 0.7},    highland_max,     beach_max, "nodes_nature:wrotycz_seed"        , nil          , nil,         nil                  , nil                             ,      nil,   1,   nil, },
