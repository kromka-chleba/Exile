...
local cane_list = {
    ...
    {--[[woodlandChalinclumps_rare upland]]
        ...
        place_on = sna.woodland_on,
        sidelen = 16,
        noise_params = {offset=0.00, scale=0.0200, spread={x=16, y=16, z=16}, seed=1881, octaves=2, persist=0.7},
    ...
    {--[[ShrublandChalinclumps_rare upland]]
        ...
        place_on = sna.shrubland_on,
        sidelen = 16,
        noise_params = {offset=0.00, scale=0.0300, spread={x=16, y=16, z=16}, seed=1881, octaves=2, persist=0.7},
        y_max = sna.upland_max-10,
        y_min = sna.lowland_max,
        schematic = chalin,
    },
    ...
    {--[[Duneland:Saguati]]
        ...
        place_on = sna.duneland_on,
        sidelen = 16,
        noise_params = {offset=0.00, scale=0.0300, spread={x=64, y=64, z=64}, seed=998, octaves=2, persist=0.7},
        y_max = sna.upland_max,
    ...
    {--[[Duneland:Saguati tall]]
        ...
        place_on = sna.duneland_on,
        sidelen = 16,
        noise_params = {offset=0.00, scale=0.0150, spread={x=64, y=64, z=64}, seed=997, octaves=2, persist=0.7},
        y_max = sna.upland_max,
    ...
    {--[[Duneland:Saguati short]]
        ...
        place_on = sna.duneland_on,
        sidelen = 16,
        noise_params = {offset=0.00, scale=0.0150, spread={x=64, y=64, z=64}, seed=996, octaves=2, persist=0.7},
        y_max = sna.upland_max,
    ...
    {--[[Allbarren:Saguati]]
        ...
        sidelen = 16,
        noise_params = {offset=0.00, scale=0.0003, spread={x=64, y=64, z=64}, seed=998, octaves=2, persist=0.7},
        y_max = sna.lowland_max,
        y_min = sna.beach_max + 1,
        schematic = deco.find_schematic("saguati"),
        flags = "place_center_x, place_center_z",
    ...
    {--[[Allbarren:Saguati tall]]
        ...
        place_on = sna.barrenland_on,
        sidelen = 16,
        noise_params = {offset=0.00, scale=0.00015, spread={x=64, y=64, z=64}, seed=997, octaves=2, persist=0.7},
        y_max = sna.upland_max,
        y_min = sna.beach_max + 3,
        schematic = deco.find_schematic("saguati_tall"),
        flags = "place_center_x, place_center_z",
    ...
    {--[[Allbarren:Saguati short]]
        ...
        place_on = sna.barrenland_on,
        sidelen = 16,
        noise_params = {offset=0.00, scale=0.00015, spread={x=64, y=64, z=64}, seed=996, octaves=2, persist=0.7},
        y_max = sna.upland_max,
        y_min = sna.beach_max + 2,
        schematic = deco.find_schematic("saguati_short"),
        flags = "place_center_x, place_center_z",
    ...
    {--[[Allbarren:tiken]]
        ...
        place_on = sna.barrenland_on,
        sidelen = 16,
        noise_params = {offset=0.00, scale=0.0020, spread={x=64, y=64, z=64}, seed=998, octaves=2, persist=0.9},
        y_max = sna.beach_max+3,
        y_min = sna.beach_max,
        schematic = tiken,
    },
