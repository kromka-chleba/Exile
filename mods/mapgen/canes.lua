...
local cane_list = {
    ...
    {--[[Marshland:cana]]
        ...
        noise_params = {offset=0.00, scale=0.5000, spread={x=64, y=64, z=64},
                        seed=578, octaves=2, persist=0.6},
    ...
    {--[[Grassland:gemedi]]
        ...
        sidelen = 16,
        noise_params = {offset=0.00, scale=0.5000, spread={x=64, y=64, z=64},
                        seed=998, octaves=2, persist=0.6},
    ...
    {--[[woodlandChalinclumps]]
        ...
        sidelen = 16,
        noise_params = {offset=0.00, scale=0.1000, spread={x=32, y=32, z=32},
                        seed=1881, octaves=2, persist=0.8},
    ...
    {--[[woodlandChalinclumps_rare upland]]
        ...
        place_on = sna.woodland_on,
        sidelen = 16,
        noise_params = {offset=0.00, scale=0.0200, spread={x=32, y=32, z=32},
                        seed=1881, octaves=2, persist=0.8},
    ...
    {--[[ShrublandChalinclumps]]
        ...
        sidelen = 16,
        noise_params = {offset=0.00, scale=0.1000, spread={x=32, y=32, z=32},
                        seed=1881, octaves=3, persist=0.8},
    ...
    {--[[ShrublandChalinclumps_rare upland]]
        ...
        place_on = sna.shrubland_on,
        sidelen = 16,
        noise_params = {offset=0.00, scale=0.0300, spread={x=32, y=32, z=32},
                        seed=1881, octaves=2, persist=0.8},
        y_max = sna.upland_max-10,
        y_min = sna.lowland_max,
        schematic = chalin,
