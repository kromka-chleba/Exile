...
local woody_plants = {
    {--[[Marshland:bronach]]
        ...
        sidelen = 16,
        noise_params = {offset=0.00, scale=0.0700, spread={x=16, y=16, z=16}, seed=1707, octaves=2, persist=0.9},
        y_max = sna.lowland_max,
        y_min = sna.beach_max,
    ...
    {--[[Grassland:gitiri]]
        ...
        place_on = sna.grassland_on,
        sidelen = 16,
        noise_params = {offset=0.00, scale=0.0500, spread={x=32, y=32, z=32}, seed=1001, octaves=2, persist=0.6},
        y_max = sna.highland_max,
        y_min = sna.beach_max,
    ...
    {--[[Shrubland:gitiri]]
        ...
        place_on = sna.shrubland_on,
        sidelen = 16,
        noise_params = {offset=0.00, scale=0.2000, spread={x=32, y=32, z=32}, seed=1001, octaves=2, persist=0.6},
        y_max = sna.highland_max,
        y_min = sna.beach_max,
        decoration = "nodes_nature:gitiri",
        param2 = 2,
...
local moss_and_stuff = {
    {--[[wetland:denser moss in marsh]]
        ...
        place_on = sna.wetland_on,
        sidelen = 16,
        noise_params = {offset=0.00, scale=0.4000, spread={x=16, y=16, z=16}, seed=1640, octaves=2, persist=0.8},
        y_max = sna.lowland_max,
        y_min = sna.beach_max,
    ...
    {--[[forest:denser moss]]
        ...
        place_on = sna.forest_on,
        sidelen = 16,
        noise_params = {offset=0.00, scale=0.6000, spread={x=16, y=16, z=16}, seed=1640, octaves=2, persist=0.7},
        y_max = sna.lowland_max,
        y_min = sna.beach_max,
        decoration = "nodes_nature:moss",
    },
