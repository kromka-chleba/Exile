...
local m_hud_data = {} -- EXILE hud data store
EXILE = EXILE
...
EXILE.update_hotbar_slotnums = function(player, hotbar_itemcount)
    local func_name = "EXILE.update_hotbar_slotnums"
    -- check args
    -- {
    ...
    local hotbar_itemcount_clamped = EXILE.math_clamp(hotbar_itemcount, 1, 32)
