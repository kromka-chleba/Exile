...
--   used by add_watcher
function EXILE.get_watchers(pos, create)
...
function EXILE.add_watcher(pos, pname)
    local wt = EXILE.get_watchers(pos, true) -- watch_table
...
function EXILE.remove_watcher(pos, pname)
    local wt = EXILE.get_watchers(pos) -- watch_table
...
function EXILE.sound_play_watcher(pos, nodedef, open)
