function EXILE.vmanip_subregion(pos1, pos2, p1, p2)
...
local vmanip_subregion = EXILE.vmanip_subregion
local zone_instance = zone.instance
local worldpath=minetest.get_worldpath()

function EXILE.save_region(opos1, opos2, name)
            ...
            for x = r.xstart, r.xstop, r.xstep do
                ...
                if mlist[index] then
                    ...
                    if met.inventory then
                        met.inventory = EXILE.invlists2string(met.inventory)
                    end
                end
...
function EXILE.load_region(base_raw, file)
            ...
            for x = r.xstart, r.xstop, r.xstep do
                ...
                if this.meta then
                    if this.meta.inventory then
                        this.meta.inventory =
                            EXILE.string2invlists(this.meta.inventory)
                    end
...
function EXILE.get_region_size(name)
...
function EXILE.load_region_raw(name)
