...
nodes_nature.agri_soil_list = {
    {"clay_agricultural_soil", S("Clay Agricultural Soil"),
     2, "nodes_nature:clay", "clay"},
    {"silt_agricultural_soil", S("Silty Agricultural Soil"),
     3, "nodes_nature:silt", "silt"},
    {"sand_agricultural_soil", S("Sandy Agricultural Soil"),
     3, "nodes_nature:sand", "sand"},
    {"gravel_agricultural_soil", S("Stony Agricultural Soil"),
     3, "nodes_nature:gravel", "gravel"},
    {"loam_agricultural_soil", S("Loamy Agricultural Soil"),
     3, "nodes_nature:loam", "loam"},
}
