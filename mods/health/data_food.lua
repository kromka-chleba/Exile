...
food_table = {
	...
	--food and water                       hp  th   hu  en  te
        ...
        ["nodes_nature:ziarnoplon_fruit"]         = { 0,  1,   1,  -4,  0 },
        ["nodes_nature:srebroplon_fruitless"]     = { 0,  3,   1,  0,  0 },
        ["nodes_nature:srebroplon_flowering"]     = { 0,  2,   1,  -6,  0 },
        ["nodes_nature:srebroplon_fruiting"]      = { 0,  3,   4,  -4,  0 },
        ["nodes_nature:srebroplon_fruit"]         = { 0,  1,   1,  -4,  0 },
        ["nodes_nature:obesa_fruit"]        = { 0,  8,   1,  0,  0 },
        ["nodes_nature:malina_fruit"]       = { 0,  2,   4,  0,  0 },
        ["nodes_nature:yellow_malina_fruit"]= { 0,  3,   4,  0,  0 },
        ["nodes_nature:malinka_fruit"]      = { 0,  2,   2,  0,  0 },
        ...
        ["nodes_nature:barszcz_fruit"]      = { 0,  1,   1,  0,  0 },
        ["nodes_nature:barszcz_fruiting"]   = { 0,  1,   3,  0,  0 },
        ["nodes_nature:barszcz_flowering"]  = { 0,  1,   2,  0,  0 },
        ["nodes_nature:barszcz_fruitless"]  = { 0,  1,   2,  0,  0 },
        ["nodes_nature:barszcz_root"]       = { 0,  1,   4,  1,  0 },
	...
	["nodes_nature:marbhan"]            = { 0,  0,   1,  -10,  0 },
        ...
        ["nodes_nature:obesa_fruitless"]    = { -2,  10,   6,  -4,  0 },
        ["nodes_nature:obesa_fruiting"]     = { -2,  10,   6,  -4,  0 },
        ["nodes_nature:obesa_flowering"]    = { -2,  10,   6,  -4,  0 },
