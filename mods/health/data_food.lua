...
HEALTH.harm_table = {
  ...
  ["tech:maraka_bread_cooked"]     = {bm_fp},
	...
	["tech:peeled_anperla_cooked"]   = { {tags="Food Poisoning",ch=0.002,sv=1} },
  ...
  -- cooked
  ["nodes_nature:sea_lettuce_cooked"] = { {tags="Food Poisoning",ch=0.002,sv=1} },
  -- fruits (not fruting)
  ["nodes_nature:obesa_fruit"]     = {bm_fp},
	["nodes_nature:muhle_fruit"]    = { {tags="Photosensitivity",ch=0.001,sv=1} },
	["nodes_nature:salia_fruit"]    = { {tags="Neurotoxicity",ch=0.001,sv=1} },
  ["nodes_nature:ziarnoplon_fruit"] = { {tags="Food Poisoning",ch=0.6,sv=1},
                                        {tags="Hepatotoxicity",ch=0.1,sv=1}},
  ["nodes_nature:srebroplon_fruit"] = { {tags="Food Poisoning",ch=0.6,sv=1},
                                        {tags="Hepatotoxicity",ch=0.1,sv=1}},
  ["nodes_nature:wrotycz_fruit"]   = { {tags="Food Poisoning",ch=0.1,sv=1},
                                        {tags="Hepatotoxicity",ch=0.005,sv=1} },
  ["nodes_nature:momo_fruit"]      = {bm_fp},
  ["nodes_nature:barszcz_fruit"]      = { {tags="Food Poisoning",ch=0.4,sv=1},
  ...
  ["nodes_nature:sasaran_fruit"]    = { {tags="Food Poisoning",ch=0.08,sv=1} },
  ...
  ["nodes_nature:panasee_fruit"]   = {bm_fp},
	...
	["nodes_nature:daoja_fruit"]     = { bm_fp,
                                        {tags="Hepatotoxicity",ch=0.2,sv=1}},
  -- seeds
  ["nodes_nature:vansano_seed"]    = {bm_fp},
	["nodes_nature:tikusati_seed"]   = {bm_fp},
  -- mushrooms
  ["nodes_nature:nebiyi"]          = {bm_fp,
                                      {tags="Hepatotoxicity",ch=0.75,sv={1,4} }},
	["nodes_nature:marbhan"]         = {bm_fp,
                                      {tags="Neurotoxicity",ch=0.75,sv={1,4} } },
  ...
  ["nodes_nature:gevaari"]         = {bm_fp,
                                      {tags="Hepatotoxicity",ch=1,sv=1} },
  ["nodes_nature:obesa"]           = { {tags="Food Poisoning",ch=0.5,sv=1},
                                        {tags="Hepatotoxicity",ch=0.001,sv=1}},
  ["nodes_nature:obesa_flowering"] = { {tags="Food Poisoning",ch=0.5,sv=1},
                                        {tags="Hepatotoxicity",ch=0.001,sv=1}},
  ["nodes_nature:obesa_fruitless"] = { {tags="Food Poisoning",ch=0.5,sv=1},
                                      {tags="Hepatotoxicity",ch=0.001,sv=1}},
  ["nodes_nature:ziarnoplon_flowering"] = { {tags="Food Poisoning",ch=0.6,sv=1},
                                            {tags="Hepatotoxicity",ch=0.1,sv=1}},
  ["nodes_nature:ziarnoplon_fruiting"]  = { {tags="Food Poisoning",ch=0.6,sv=1},
                                            {tags="Hepatotoxicity",ch=0.1,sv=1}},
  ["nodes_nature:ziarnoplon_fruitless"] = {bm_fp},
  ["nodes_nature:srebroplon_flowering"] = { {tags="Food Poisoning",ch=0.6,sv=1},
                                            {tags="Hepatotoxicity",ch=0.1,sv=1}},
  ["nodes_nature:srebroplon_fruiting"]  = { {tags="Food Poisoning",ch=0.6,sv=1},
                                            {tags="Hepatotoxicity",ch=0.1,sv=1}},
  ...
  ["nodes_nature:galanta_seedling2"]  = { {tags="Food Poisoning",ch=0.002,sv=1} },
  ["nodes_nature:galanta_seedling3"]  = { {tags="Food Poisoning",ch=0.003,sv=1} },
  ["nodes_nature:galanta_seedling4"]  = { {tags="Food Poisoning",ch=0.004,sv=1} },
  ["nodes_nature:galanta_seedling5"]  = { {tags="Food Poisoning",ch=0.005,sv=1} },
  ...
  ["nodes_nature:damo_seedling5"]  = {bm_fp},
	...
	["nodes_nature:fretin_seedling1"]  = {{tags="Photosensitivity",ch=0.001,sv=1}},
	["nodes_nature:fretin_seedling2"]  = {{tags="Photosensitivity",ch=0.002,sv=1}},
	["nodes_nature:fretin_seedling3"]  = {{tags="Photosensitivity",ch=0.003,sv=1}},
	["nodes_nature:fretin_seedling4"]  = {{tags="Photosensitivity",ch=0.004,sv=1}},
	["nodes_nature:fretin_seedling5"]  = {{tags="Photosensitivity",ch=0.005,sv=1}},

  ["nodes_nature:momo_fruiting"]   = {bm_fp},
  ["nodes_nature:momo_fruitless"]  = {bm_fp},
  ["nodes_nature:momo_flowering"]  = { {tags="Food Poisoning",ch=0.4,sv=1},
                                        {tags="Hepatotoxicity",ch=0.3,sv={1,2} }},
  ["nodes_nature:barszcz_fruiting"]   = { {tags="Food Poisoning",ch=0.4,sv=1},
                                          {tags="Hepatotoxicity",ch=0.1,sv={1,2} }},
  ["nodes_nature:barszcz_fruitless"]  = { {tags="Food Poisoning",ch=0.4,sv=1},
                                          {tags="Hepatotoxicity",ch=0.1,sv={1,2} }},
  ["nodes_nature:barszcz_flowering"]  = { {tags="Food Poisoning",ch=0.4,sv=1},
                                          {tags="Hepatotoxicity",ch=0.1,sv={1,2} }},
  ["nodes_nature:barszcz_root"]       = { {tags="Food Poisoning",ch=0.01,sv=1},
                                          {tags="Hepatotoxicity",ch=0.01,sv={1,2} }},
  ["nodes_nature:rzepicha_root"]     = {bm_fp},
  ["nodes_nature:rzepicha_root_winter"]     = {bm_fp},
  -- sea plants
  ["nodes_nature:sea_lettuce"]     = { {tags="Food Poisoning",ch=0.050,sv=1},
                                      {tags="Intestinal Parasites",ch=0.010} },
  -- meats
  ["animals:carcass_invert_small"] = { {tags="Food Poisoning",ch=0.1,sv=1},
	                                     {tags="Intestinal Parasites",ch=0.01,sv=1} },
	["animals:carcass_invert_small_cooked"] = { {tags="Food Poisoning",ch=0.002,sv=1} },
	["animals:carcass_invert_small_burned"] = { bm_fp },
	["animals:carcass_invert_large"] = { {tags="Food Poisoning",ch=0.2,sv=1},
	                                     {tags="Intestinal Parasites",ch=0.02,sv=1} },
	["animals:carcass_invert_large_cooked"] = { {tags="Food Poisoning",ch=0.002,sv=1} },
	["animals:carcass_invert_large_burned"] = { bm_fp },
	["animals:carcass_bird_small"]   = { {tags="Food Poisoning",ch=0.05,sv=1},
	                                     {tags="Intestinal Parasites",ch=0.02,sv=1} },
	["animals:carcass_bird_small_cooked"] = { {tags="Food Poisoning", 0.002,sv=1} },
	["animals:carcass_bird_small_burned"] = { bm_fp },
	["animals:carcass_fish_small"]   = { {tags="Food Poisoning",ch=0.05,sv=1},
	                                     {tags="Intestinal Parasites",ch=0.02,sv=1} },
	["animals:carcass_fish_small_cooked"] = { {tags="Food Poisoning",ch=0.002,sv=1} },
	["animals:carcass_fish_small_burned"] = { bm_fp },
	["animals:carcass_fish_large"]   = { {tags="Food Poisoning",ch=0.1,sv=1},
	                                     {tags="Intestinal Parasites",ch=0.04,sv=1} },
	["animals:carcass_fish_large_cooked"] = { {tags="Food Poisoning",ch=0.004,sv=1} },
	["animals:carcass_fish_large_burned"] = { {tags="Food Poisoning",ch=0.002,sv=1} },
	--eggs
	["animals:darkasthaan_eggs"]     = { {tags="Food Poisoning",ch=0.1,sv={1,4} },
	                                     {tags="Intestinal Parasites",ch=0.01,sv=1} },
	["animals:gundu_eggs"]           = { {tags="Food Poisoning",ch=0.05,sv={1,4} },
	                                     {tags="Intestinal Parasites",ch=0.1,sv=1} },
	["animals:impethu_eggs"]         = { {tags="Food Poisoning",ch=0.1,sv={1,4} },
	                                     {tags="Intestinal Parasites",ch=0.1,sv=1} },
	["animals:kubwakubwa_eggs"]      = { {tags="Food Poisoning",ch=0.1,sv={1,4} },
	                                     {tags="Intestinal Parasites",ch=0.01,sv=1} },
	["animals:pegasun_eggs"]         = { {tags="Food Poisoning",ch=0.02,sv={1,2} },
	                                     {tags="Intestinal Parasites",ch=0.005,sv=1} },
	["animals:sarkamos_eggs"]       = { {tags="Food Poisoning",ch=0.3,sv={1,4} },
	                                     {tags="Intestinal Parasites",ch=0.05,sv=1} },
	["animals:sneachan_eggs"]       = { {tags="Food Poisoning",ch=0.5,sv={1,4} },
...
HEALTH.cure_table = {
  ...
  ["nodes_nature:hakimi_flowering"] = {ch=0.75,sv=1,{tags="Food Poisoning","Fungal Infection", "Dust Fever"} },
  -- merki is anti-parasitic
  ["nodes_nature:merki"] = { {tags="Intestinal Parasites",ch=0.15,sv=1} },
  -- medicine/drugs
  --cure/reduce food poisoning and infections
  ["tech:herbal_medicine"] = {function() -- custom supported function argument
                              local cure = {ch=1,sv=1,tags={"Food Poisoning","Fungal Infection","Dust Fever"}}
                              local c = math.random()
                            ...
                            {tags="Intestinal Parasites",ch=0.33,sv=1}}
}
