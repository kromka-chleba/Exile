      ...
      for vi, x, y, z in area:iterp_xyz(minp, maxp) do
         ...
         if y < depth_base then
            ...
            elseif y < depth_root + chamber_radius * 2 then
               ...
               local upper_half =
                  (1 - (y - depth_root - chamber_radius) / chamber_radius) * chamber_radius
         ...
         elseif y < depth_peak + 5 then -- cone
            ...
            if current_elevation > peak_elevation - caldera
               and distance < current_elevation - peak_elevation + caldera then
            ...
            if pos.x and pos.y and pos.z then
               if not send_nearby_states(pos, name) then
                  minetest.chat_send_player(
                     name, "No volcanoes near " .. minetest.pos_to_string(pos))
               end
               return true
            else
