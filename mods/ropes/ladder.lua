...
local function ladder_place(pos, placer,length)
    ...
    -- param2 holds the facing direction of this node.
    --  If it's 0 or 1 the node is "flat" and we don't want
    ...
    if node_below.name == "air" and this_node.param2 > 1
        ...
        minetest.add_node(pos_below, {name="ropes:ropeladder_bottom",
                                      param2=this_node.param2})
...
local rope_ladder_top_def = {
    ...
    after_destruct = function(pos)
        local pos_below = {x=pos.x, y=pos.y-1, z=pos.z}
        ropes.destroy_rope(pos_below, {"ropes:ropeladder",
...
minetest.register_node(
    "ropes:ropeladder", {
        ...
        after_destruct = function(pos)
            ropes.hanging_after_destruct(
                pos, "ropes:ropeladder_falling",
                "ropes:ropeladder",
                "ropes:ropeladder_bottom")
        end,
})
