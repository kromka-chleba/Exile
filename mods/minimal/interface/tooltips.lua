-- auto generate _tool_tips for all registered items defining  _dig_tip, _use_tip, or _place_tip
-- Stored in def._tool_tips -- crafting/api.lua sets meta description using it which appears with mouseover.
