...
for _, item in pairs(default_exits) do table.insert(crossroads, table.copy(item)) end

if seal_underground then table.insert(crossroads, 1, table.copy(seal_box)) end
...
if seal_underground then table.insert(air_shaft, 1, table.copy(seal_box)) end
...
if seal_underground then table.insert(air_shaft_thin, 1, table.copy(seal_box)) end
...
if seal_underground then table.insert(highway, 1, table.copy(seal_box)) end
...
if seal_underground then table.insert(highway_no_shaft, 1, table.copy(seal_box)) end
...
if seal_underground then table.insert(highway_linked, 1, table.copy(seal_box)) end
...
for _, item in pairs(upper_stair) do table.insert(reservoir, 2, table.copy(item)) end

for _, item in pairs(lower_stair_room) do
    table.insert(reservoir, 2, table.copy(item))
end

if seal_underground then table.insert(reservoir, 1, table.copy(seal_box)) end
...
if seal_underground then table.insert(reservoir_empty, 1, table.copy(seal_box)) end
...
if seal_underground then table.insert(mushroom_garden, 1, table.copy(seal_box)) end
...
if seal_underground then table.insert(stockyards, 1, table.copy(seal_box)) end
...
for _, item in pairs(crossroads) do table.insert(granary, 2, table.copy(item)) end
...
local kitchen = {
    -- stair link rooms
    {
        act = 'cube',
        node = 'air',
        floor = stone_block_3rd,
        treasure = 3,
        loc = vn(50, 20, 47),
        size = vn(8, 3, 8)
    }, {
        act = 'stair',
        node = stone_stairs_block_3rd,
        height = 2,
        depth = 1,
        param2 = 1,
        loc = vn(58, 20, 48),
...
for _, x in pairs({25, 32, 42, 49}) do
    for _, z in pairs({33, 41, 49}) do
        table.insert(kitchen, {
                         act = 'cube',
                         node = stone_block_2nd,
                         loc = vn(x, 51, z),
                         size = vn(5, 6, 5)
        })
        table.insert(kitchen, {
...
for _, item in pairs(default_exits) do table.insert(kitchen, 2, table.copy(item)) end
...
for _, item in pairs(upper_stair) do table.insert(kitchen, 2, table.copy(item)) end

for _, item in pairs(lower_stair) do table.insert(kitchen, 2, table.copy(item)) end
...
for _, item in pairs(upper_cross) do table.insert(prison, 2, table.copy(item)) end

for _, item in pairs(lower_stair_room) do
    table.insert(prison, 2, table.copy(item))
end

if seal_underground then table.insert(prison, 1, table.copy(seal_box)) end
...
if seal_underground then table.insert(stair_base, table.copy(seal_box)) end
...
if seal_underground then table.insert(great_hall, 1, table.copy(seal_box)) end
...
if seal_underground then table.insert(grand_apartments, 1, table.copy(seal_box)) end
...
for _, item in pairs(lower_stair) do table.insert(market, 2, table.copy(item)) end

if seal_underground then table.insert(market, 1, table.copy(seal_box)) end

for _, item in pairs(default_exits) do table.insert(market, 2, table.copy(item)) end
...
for _, item in pairs(default_exits) do table.insert(arena, 2, table.copy(item)) end

for _, item in pairs(upper_cross) do table.insert(arena, 2, table.copy(item)) end

for _, item in pairs(upper_stair) do table.insert(arena, 2, table.copy(item)) end

for _, item in pairs(lower_stair_room) do
    table.insert(arena, 2, table.copy(item))
end

if seal_underground then table.insert(arena, 1, table.copy(seal_box)) end
...
if seal_underground then table.insert(grand_bazaar, 1, table.copy(seal_box)) end
...
for _, item in pairs(upper_cross) do table.insert(plaza, 2, table.copy(item)) end

for _, item in pairs(lower_cross) do table.insert(plaza, 2, table.copy(item)) end

for _, item in pairs(lower_cross_hash) do
    table.insert(plaza, 2, table.copy(item))
end

if seal_underground then table.insert(plaza, 1, table.copy(seal_box)) end
...
if seal_underground then table.insert(silly_straw, 1, table.copy(seal_box)) end
...
if seal_underground then table.insert(pillared_room, 1, table.copy(seal_box)) end
...
local jade_temple = {
    ...
    {act = 'cube', node = 'air', loc = vn(5, 50, 5), size = vn(70, 1, 70)}, {
        ...
        act = 'cube',
        node = "artifacts:sculpture_j_axeman",
        param2 = 0,
        random = 30,
        loc = vn(5, 21, 5),
        size = vn(70, 1, 70)
    ...
    {act = 'cube', node = lamp_block, loc = vn(42, 33, 36), size = vn(2, 1, 2)},
    {
        ...
        act = 'cube',
        node = "artifacts:sculpture_j_dragon_head",
        param2 = 2,
        loc = vn(38, 22, 52),
        size = vn(1, 1, 1)
                               }, {
...
if seal_underground then table.insert(jade_temple, 1, table.copy(seal_box)) end
...
if seal_underground then table.insert(fountain_court, 1, table.copy(seal_box)) end
...
if seal_underground then table.insert(sphere_of_light, 1, table.copy(seal_box)) end
...
for _, item in pairs(lower_stair) do table.insert(forum, 2, table.copy(item)) end

for _, item in pairs(upper_stair) do table.insert(forum, 2, table.copy(item)) end

if seal_underground then table.insert(forum, 1, table.copy(seal_box)) end
...
if seal_underground then table.insert(lake_of_fire, 1, table.copy(seal_box)) end
...
for _, item in pairs(upper_stair) do table.insert(warehouse, 2, table.copy(item)) end

for _, item in pairs(lower_stair) do table.insert(warehouse, 2, table.copy(item)) end

for _, item in pairs(central_stairwell) do
    table.insert(warehouse, 2, table.copy(item))
end

if seal_underground then table.insert(warehouse, 1, table.copy(seal_box)) end
...
if seal_underground then table.insert(deep_stair, 1, table.copy(seal_box)) end
